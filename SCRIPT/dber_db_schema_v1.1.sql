...
-- Dump completed on 2018-03-21 10:35:57
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
...
CREATE TABLE `shop` (
  `id` int(10) unsigned NOT NULL COMMENT '实际为account_id(所属账号id)',
  `name` varchar(20) DEFAULT NULL COMMENT '店铺名称（全名）',
  `address` varchar(60) DEFAULT NULL COMMENT '店铺详细地址',
  `tellphone` varchar(20) DEFAULT NULL COMMENT '店铺服务电话',
  `manager` varchar(10) DEFAULT NULL COMMENT '店长（经理）',
  `manager_phone` varchar(20) DEFAULT NULL COMMENT '店长（经理）电话',
  `business_begin` smallint(6) DEFAULT '570' COMMENT '营业开始时间',
  `business_end` smallint(6) DEFAULT '1350' COMMENT '营业结束时间',
  `area` int(11) DEFAULT NULL COMMENT '占地面积（建筑或室内），单位平米',
  `chain` tinyint(4) DEFAULT NULL COMMENT '是否连锁经营：1-是、2-否',
  `bathing` tinyint(4) DEFAULT NULL,
  `sauna` tinyint(4) DEFAULT NULL,
  `air_system` tinyint(4) DEFAULT NULL,
  `physical_testing` varchar(255) DEFAULT NULL,
  `status` tinyint(4) DEFAULT '1' COMMENT '店铺状态：\n    NEW(11,"新注册"),\n    AUDITING(21,"审核中"),\n    AUDIT_FAILURE(22,"拒绝申请"),\n    ENQUIRING(31,"询价中（待提交期望门店价）"),\n    EVALUATE_BASE_PRICE(32,"评估基础价格中"),\n    ENQUIRING_HIGHER(33,"期望价过高"),\n    ENQUIRING_LOWER(34,"期望价过低"),\n    BUSINESSING_NO_SERVICE(41,"营业中（无服务）"),\n    BUSINESSING_WITH_SERVICE(42,"营业中（有服务）"),\n    BUSINESS_SUSPEND(51,"休业中"),\n    CLOSED(52,"已关店")',
  `matrix_code_id` int(10) unsigned DEFAULT NULL COMMENT '店铺二维码图片id',
  `score` int(10) unsigned DEFAULT NULL COMMENT '当前店铺分数',
  `level` tinyint(3) unsigned DEFAULT NULL COMMENT '当前店铺级别（未来需要有级别代号）',
  `base_price` double DEFAULT '10',
  `expect_price` double unsigned DEFAULT NULL COMMENT '期望常规消费价，单位分',
  `price` double unsigned DEFAULT NULL COMMENT '实际常规消费价',
  `img_id` int(10) unsigned DEFAULT NULL COMMENT '店铺主页图片',
...
--
-- Table structure for table `shop_customer_view_count`
--

DROP TABLE IF EXISTS `shop_customer_view_count`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_view_count` (
  `shop_id` int(10) unsigned NOT NULL,
  `_date` date NOT NULL COMMENT '统计日',
  `_count` int(10) unsigned NOT NULL COMMENT '到店人数',
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`shop_id`,`_date`),
  CONSTRAINT `shop_customer_view_count_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='到店消费顾客表记录（根据扫店二维码）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_evaluate` (
  ...
  CONSTRAINT `shop_evaluate_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`)
...
CREATE TABLE `shop_group` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `site_booking_id` bigint(20) unsigned DEFAULT NULL,
  `shop_id` int(10) unsigned NOT NULL,
  `site_id` bigint(20) unsigned NOT NULL,
  `coacher_id` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '团体教练id',
  `shop_service_id` int(10) unsigned NOT NULL,
  `_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '\r\n\r\n针对团体课：\r\n1-发布；\r\n2-撤销；\r\n3-已过期；',
  `coacher_price` double(10,0) unsigned NOT NULL DEFAULT '0' COMMENT '团体教练的价格',
  `shop_name` varchar(20) NOT NULL,
  `service_name` varchar(20) NOT NULL,
  `site_name` varchar(20) NOT NULL COMMENT '场馆名称冗余',
  `coacher_name` varchar(20) DEFAULT NULL COMMENT '顾客订场用户姓名（或昵称） 或团体教练姓名',
  `coacher_cellphone` varchar(20) DEFAULT NULL COMMENT '团体教练电话',
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `account_id` (`coacher_id`,`booking_date`) USING BTREE,
  KEY `shop_id` (`shop_id`,`shop_service_id`,`booking_date`) USING BTREE,
  KEY `fk_shop_site_booking_detail_shop_service_1` (`shop_service_id`) USING BTREE,
  KEY `fk_shop_site_group_booking_detail_shop_site_booking_1` (`site_booking_id`) USING BTREE,
  CONSTRAINT `shop_group_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`),
  CONSTRAINT `shop_group_ibfk_2` FOREIGN KEY (`shop_service_id`) REFERENCES `shop_service` (`id`),
  CONSTRAINT `shop_group_ibfk_3` FOREIGN KEY (`site_booking_id`) REFERENCES `shop_site_booking` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='场地预订、预约、出租等详情表\r\n\r\n一个人只能预订一个店铺最长消费时长\r\n每人每天最多只能取消五次预约，超过五次强制取消将收取违约费';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_group_customer_booking`
--

DROP TABLE IF EXISTS `shop_group_customer_booking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_group_customer_booking` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `booking_detail_id` (`booking_detail_id`) USING BTREE,
  CONSTRAINT `shop_group_customer_booking_ibfk_1` FOREIGN KEY (`booking_detail_id`) REFERENCES `shop_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团体课程预约用户，未来针对团体课程单独收费的，可兼容团体课程顾客表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_position`
--
...
CREATE TABLE `shop_position` (
  `id` int(10) unsigned NOT NULL COMMENT '店铺id',
  `name` varchar(20) NOT NULL COMMENT '店铺名称冗余',
  `lat` int(10) unsigned NOT NULL COMMENT '纬度(越往北，纬度值越大)',
  `lng` int(10) unsigned NOT NULL COMMENT '经度（越往西，经度值越大）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_rating` (
  ...
  `base_score` smallint(5) unsigned NOT NULL COMMENT '基本硬件分数（数据主要来自于shop表）',
  `service_item_score` smallint(5) unsigned NOT NULL COMMENT '服务项目分数（主要来自于service_item表）',
  `customer_count` int(10) unsigned NOT NULL COMMENT '当月顾客数量',
  `customer_evaluate_score` smallint(5) unsigned NOT NULL COMMENT '当月顾客评价平均分数（总分数*100/评价人数）',
  `coacher_count` int(10) unsigned NOT NULL COMMENT '私教到店数量',
  `coacher_evaluate_score` smallint(5) unsigned NOT NULL COMMENT '私教评价平均分数（总分数*100/评价数量）',
  `congestion_degree` smallint(5) unsigned NOT NULL COMMENT '店铺拥挤度',
  `score` int(10) unsigned NOT NULL COMMENT '最终分数',
  `level` tinyint(3) unsigned NOT NULL COMMENT '本月最终获评等级',
  `evalute_price` double(10,0) unsigned NOT NULL COMMENT '评估常规消费价格',
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shop_id` (`shop_id`) USING BTREE,
  CONSTRAINT `shop_rating_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`)
...
CREATE TABLE `shop_service` (
  ...
  `shop_id` int(10) unsigned NOT NULL,
  `service_id` smallint(5) unsigned NOT NULL COMMENT '服务项目id',
  `_type` tinyint(255) DEFAULT NULL COMMENT '废弃字段',
  `service_name` varchar(20) NOT NULL COMMENT '服务名称冗余',
  `_count` smallint(6) DEFAULT '0' COMMENT '该场地、服务位置个数、最大容纳人数等的数量',
  `_group` tinyint(255) NOT NULL,
  `group_price` double NOT NULL DEFAULT '0',
  `share_site` tinyint(255) NOT NULL,
  `coach` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否允许私人教练：1-是，2-否',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态：1-新建，2-启用，3-停用',
  `price` double NOT NULL DEFAULT '0' COMMENT '（团体课程或者订场的默认价格）服务价格',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shop_id` (`shop_id`) USING BTREE,
  CONSTRAINT `shop_service_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='店铺服务清单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_site` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `shop_id` int(10) unsigned NOT NULL,
  `shop_service_id` int(10) unsigned NOT NULL DEFAULT '1',
  `name` varchar(20) NOT NULL COMMENT '场馆或场地名称',
  `price` double(11,0) DEFAULT '0' COMMENT '场馆每小时出租或预约价格',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shop_service_id` (`shop_service_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='所支持的健身项目的场地';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_site_booking`
--

DROP TABLE IF EXISTS `shop_site_booking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_site_booking` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '使用shop_site_booking_detail表的id，与其一一对应',
  `site_id` bigint(20) unsigned NOT NULL,
  `booking_date` date NOT NULL,
  `time_begin` smallint(6) NOT NULL COMMENT '使用起始时间，单位分钟',
  `time_end` smallint(6) NOT NULL COMMENT '使用结束时间',
  `_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1-启用；\r\n2-取消；\r\n3-已过期；',
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`,`booking_date`) USING BTREE,
  CONSTRAINT `shop_site_booking_ibfk_1` FOREIGN KEY (`site_id`) REFERENCES `shop_site` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='包括团体课程预订和顾客场地预订、预约、出租等；\r\n店铺场地预订策略为，系统设置基本场地预订策略并缓存内存，店铺使用营业时间段覆盖基本策略内容为店铺自己的场地预订策略';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_vip_card`
--
...
CREATE TABLE `shop_vip_card` (
  ...
  `shop_id` int(10) unsigned NOT NULL,
  `card_strategy_id` smallint(5) unsigned NOT NULL COMMENT '年卡所使用的策略id',
  `card_name` char(3) NOT NULL,
  `price` double(11,0) NOT NULL COMMENT '真实价格',
  `_count` int(11) NOT NULL DEFAULT '0' COMMENT '销售数量',
  `transfering_count` int(11) NOT NULL DEFAULT '0' COMMENT '转让中的数量',
  `transfered_count` int(11) NOT NULL DEFAULT '0' COMMENT '已转让数量',
  `_status` tinyint(3) unsigned NOT NULL COMMENT '状态：1-待用，2-启用（同一个店铺使用同一策略的年卡只能启用一张），3-停用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shop_id` (`shop_id`) USING BTREE,
  CONSTRAINT `shop_vip_card_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='店铺年卡销售设置\r\n抵扣所有门店费用，独立费用可选择开启；';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_vip_card_service`
--

DROP TABLE IF EXISTS `shop_vip_card_service`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_vip_card_service` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shop_id` int(10) unsigned NOT NULL,
  `shop_vip_card_id` int(10) unsigned NOT NULL COMMENT '店铺年卡id',
  `shop_service_id` int(10) unsigned NOT NULL COMMENT '店铺服务id',
  `service_name` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `shop_service_id` (`shop_service_id`,`shop_vip_card_id`) USING BTREE,
  KEY `fk_shop_vip_card_service_shop_vip_card_1` (`shop_vip_card_id`) USING BTREE,
  CONSTRAINT `shop_vip_card_service_ibfk_1` FOREIGN KEY (`shop_service_id`) REFERENCES `shop_service` (`id`),
  CONSTRAINT `shop_vip_card_service_ibfk_2` FOREIGN KEY (`shop_vip_card_id`) REFERENCES `shop_vip_card` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='年卡支持的额外收费的店铺服务项目';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='优惠规则、使用等暂时每个策略一个接口实现，将来需要形成统一的模板策略服务\n充值优惠（一般与其他优惠可叠加）：满赠、折扣\n分全局优惠、指定用户优惠、店铺促销优惠';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dfile` (
  ...
  PRIMARY KEY (`id`),
  KEY `bs_id` (`bs_id`,`_type`) USING BTREE
...
CREATE TABLE `customer` (
  ...
  `_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '用户状态：\r\n1-暂停消费\r\n2-激活消费',
  `holiday_count` tinyint(4) NOT NULL DEFAULT '30',
  `fitness_count` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '健身次数',
  `score` int(11) NOT NULL DEFAULT '0' COMMENT '积分：通过健身次数、消费私教课程获得',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='头像存储在plat_img,bs_id为用户id，若没找到则为未认证头像或认证过期';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customer_holiday` (
  ...
  CONSTRAINT `customer_holiday_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
...
CREATE TABLE `shop_focus` (
  ...
  KEY `customer_id` (`customer_id`) USING BTREE,
  KEY `shop_id` (`shop_id`) USING BTREE,
  CONSTRAINT `shop_focus_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_site_customer_booking` (
  ...
  `content` varchar(200) DEFAULT NULL COMMENT '场地预订事项描述 或 需求描述',
  `price` double unsigned NOT NULL DEFAULT '0' COMMENT '订场价格',
  `booking_date` date NOT NULL,
  `time_begin` smallint(6) NOT NULL,
  `time_end` smallint(6) NOT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`,`booking_date`) USING BTREE,
  KEY `shop_id` (`shop_id`,`shop_service_id`,`booking_date`) USING BTREE,
  CONSTRAINT `shop_site_customer_booking_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='场地预订、预约、出租等详情表\r\n\r\n一个人只能预订一个店铺最长消费时长\r\n每人每天最多只能取消五次预约，超过五次强制取消将收取违约费';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_vip_card_customer` (
  ...
  KEY `customer_id` (`customer_id`) USING BTREE,
  KEY `shop_id` (`shop_id`) USING BTREE,
  CONSTRAINT `shop_vip_card_customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_vip_card_transfer` (
  ...
  `shop_id` int(10) unsigned NOT NULL,
  `shop_vip_card_id` int(10) unsigned NOT NULL,
  `customer_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '购买人',
  `shop_name` varchar(20) NOT NULL,
  `card_name` char(3) NOT NULL,
  ...
  KEY `shop_id` (`shop_id`) USING BTREE,
  KEY `customer_id` (`customer_id`) USING BTREE,
  CONSTRAINT `shop_vip_card_transfer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`),
  CONSTRAINT `shop_vip_card_transfer_ibfk_2` FOREIGN KEY (`id`) REFERENCES `shop_vip_card_customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='转让年卡';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `account` (
  ...
  `_system` tinyint(3) unsigned NOT NULL COMMENT '所属平台，与数据字典保持一致',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='用户账户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `account_third_open` (
  ...
  KEY `fk_account_third_open_account_customer_1` (`customer_id`) USING BTREE,
  KEY `fk_account_third_open_account_customer_2` (`coacher_id`) USING BTREE,
  KEY `fk_account_third_open_account_3` (`shop_manage_id`) USING BTREE,
  CONSTRAINT `account_third_open_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `account` (`id`),
  CONSTRAINT `account_third_open_ibfk_2` FOREIGN KEY (`coacher_id`) REFERENCES `account` (`id`),
  CONSTRAINT `account_third_open_ibfk_3` FOREIGN KEY (`shop_manage_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `booking_strategy` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='标的预约时间策略表\r\n所有时间没有说明时皆以分钟为单位\r\n所有预约时间区间为前闭后开';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dict` (
  ...
  CONSTRAINT `dict_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `dict_category` (`id`)
...
CREATE TABLE `dict_category` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='字典数据在对应业务系统里面一般以枚举表示\r\n相关业务方可以利用字典表数据查询了解相关系统字典信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_instance` (
  ...
  KEY `fk_job_instance_jobs_1` (`job_id`) USING BTREE,
  CONSTRAINT `job_instance_ibfk_1` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`)
